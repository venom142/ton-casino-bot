...
app.get('/', (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .profile-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin: 14px 0; }
            .profile-stat {
    ...
    <body>
        ...
        <div id="pg5" class="page">
            ...
            <div class="card">
                ...
                <div class="small-info">Промокод можно использовать только один раз на аккаунт.</div>
            </div>
        </div>
        ...
        <script>
            ...
            function promo() {
                ...
                fetch('/api/promo', {method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({uid, promo:code})})
                .then(r=>r.json()).then(d=>{ tg.showAlert(d.msg||d.err); upd(); loadProfile(); });
            }
