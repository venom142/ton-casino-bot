...
app.get('/', (req, res) => {
    ...
    <body>
        ...
        <script>
            (function(){
                function hide(){
                    var loader = document.getElementById('vipLoader');
                    if (!loader || loader.getAttribute('data-hidden') === '1') return;
        ...
        <script>
            ...
            function hideVipLoader() {
                if (window.__hideVipLoader) window.__hideVipLoader();
            }

            const tg = (window.Telegram && window.Telegram.WebApp) ? window.Telegram.WebApp : { initDataUnsafe: {}, expand: function(){}, openTelegramLink: null };
...
const uid = (tg.initDataUnsafe && tg.initDataUnsafe.user && tg.initDataUnsafe.user.id) ? tg.initDataUnsafe.user.id : 123456789;
