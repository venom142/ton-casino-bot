    ...
    async function sendCrashRoundReport() {
        try {
            ...
            for (const [uid, b] of entries) {
                ...
                console.log(`ROUND_ID=${crashState.roundId} UID=${uid} BET=${b.bet} CASHOUT_MULTIPLIER=${b.cashoutMultiplier || 0} CRASH_POINT=${crashState.crashPoint} WIN_SUM=${b.winSum || 0} STATUS=${status}`);
            }
